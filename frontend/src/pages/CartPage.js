...
const CartPage = () => {
  ...
  const discount = () => {
    ...
    cart.map((item) => {
      discountedPrice +=
        item.price * (item.discount * 0.01) * item.quantityInCart;
    });
  ...
  const decrementQuantity = (id) => {
    const updatedCart = cart.map((item) =>
      item.item_id === id && item.quantityInCart > 1
        ? { ...item, quantityInCart: item.quantityInCart - 1 }
        : item
    );
    setCart(updatedCart);
                  ...
                  <div className="quantity-price-col">
                    ...
                    >
                      ...
                      <span>
                        ...
                        &#x20B9;
                        {myProduct.price -
                          myProduct.price * myProduct.discount * 0.01}
                      </span>
                    </p>
                    <p
                      style={{
                    ...
                    >
                      ...
                      <div className="quantity-controls-cart ">
                        <button
                          onClick={() => decrementQuantity(myProduct.item_id)}
                        >
                          -
                        </button>
                        ...
                        <button
                          onClick={() => incrementQuantity(myProduct.item_id)}
                        >
                          +
                        </button>
                      </div>
            ...
            <div className="col order-summary ">
              <div className="summary-card col  d-flex flex-column justify-content-center  p-2 card">
                ...
                <div className="col cart-disp">
                  <p
                    style={{ fontSize: "16px", margin: "0", padding: "2px 0 " }}
                  >
